...
def figColor(imagenHSV):
	...
	rojoAlto1 = np.array([13, 255, 255], np.uint8)
	...
	cntsRosa = cv2.findContours(maskAzul, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0] 
	...
	elif len(cntsRosa)>0: color = 'Azul'
...
imagen = cv2.imread('Circulos_colores.png')
...
for c in cnts:
	...
	cv2.putText(imagen,nameColor,(x,y-5),1,0.8,(0,0,0),1)
